...
UInteractionComponent::UInteractionComponent()
{
	...
	//TriggerCapsule->SetupAttachment(GetOwner()->GetRootComponent());
	//binding to events
...
void UInteractionComponent::BeginPlay()
{
	...
	if (Player)
	{
		...
		Player->OnInteractionStartRequested.AddDynamic(this, &UInteractionComponent::InteractionRequested);
	}
}
...
void UInteractionComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	...
	if (Player)
	{
		Player->OnInteractionStartRequested.RemoveAll(this);
	}
}
